...
var Tools = React.createClass({displayName: "Tools",
  ...
  getInitialState: function() {
    ...
    var toolNodes = this.state.data.map(function(tool) {
      return (
        React.createElement("li", null, React.createElement("h4", null, tool.name), React.createElement("p", null, tool.description), React.createElement("p", null, tool.url))
      );
    });

		return (
      React.createElement("ul", {id: "toolsList"}, 
        toolNodes
      )
		);
	}
...
module.exports.ToolsComponent = function(elementId) {
	React.render(
		React.createElement(Tools, {url: "src/tools_mock.json"}),
...
},{"./localize.jsx":149,"react":148}],2:[function(require,module,exports){
