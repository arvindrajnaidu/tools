!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var o;"undefined"!=typeof window?o=window:"undefined"!=typeof global?o=global:"undefined"!=typeof self&&(o=self),o.Tools=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
module.exports = {
...
},{"./dashboard":3,"./dropdown":4}],2:[function(require,module,exports){
/** @jsx React.DOM */

var React = require('react');

var Localize = React.createClass({displayName: "Localize",
	...
	render: function () {
		return (
			React.createElement("span", null, "Helloo")
		);
	}
...
var ToolsDashboard = React.createClass({displayName: "ToolsDashboard",
	...
	render: function () {
                ...
                React.createElement("div", {className: "row-fluid tools-set"}, 
                    React.createElement("div", {id: tool.key, className: cx("col-sm-3", "tool", inactiveClass)}, 
                        ...
                        React.createElement("div", {className: "toolAction"}, 
                            React.createElement("div", {className: "toolOptions"}, 
                                React.createElement("span", {className: "flow"}, 
                                    React.createElement("a", {href: tool.link}, toolStatusLabel)
                                ), 
                                React.createElement("span", {className: cx("fav", favoriteClass), onClick: this.updateFavorites.bind(this, tool)})
                            )
                        )
                    )
                )
        ...
        return (
            React.createElement("div", {id: "tools", className: "container-fluid"}, 
  ...
  $.ajax({
      ...
      success: function(data) {
          $(document).ready(function() {
              React.render(
                  React.createElement(ToolsDashboard, {url: options.basePath ? serviceUrl : "", dictionary: data ? data : {}}),
...
},{"classnames":6,"react":152}],4:[function(require,module,exports){
/** @jsx React.DOM */
...
var ToolsDropdown = React.createClass({displayName: "ToolsDropdown",
  ...
  i18n : function (key) {
    ...
    var toolNodes = this.state.data.tools.map(function(tool) {
      return (
        React.createElement("li", null, 
          React.createElement("a", {href: tool.url}, 
            this.i18n(tool.name)
          )
        )
      );
		...
		return (
      React.createElement("li", {className: "mer-more-menu"}, 
        React.createElement("a", {href: "#", className: "moreLink"}, 
          this.i18n("label")
        ), 
        React.createElement("ul", null, 
          toolNodes
...
module.exports = function (elementId, options) {
  ...
  $.ajax({
      ...
      success: function(data) {
        React.render(
          React.createElement(ToolsDropdown, {url: options.basePath? serviceUrl : "", dictionary: data?data:{}}),
          document.getElementById(elementId)
        )
      }.bind(this),
      error: function(xhr, status, err) {
...
},{"./content.jsx":2,"react":152}],5:[function(require,module,exports){
