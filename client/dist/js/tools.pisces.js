...
ContentMixin.i18n = function (key) {
    ...
    return (React.createElement("edit", {"data-key": key.contentKey, "data-bundle": key.contentBundle, "data-original": key.value}, key.value))
...
},{"../mixins/content":4,"./dashboard":2,"./dropdown":3,"react":152}],2:[function(require,module,exports){
/** @jsx React.DOM */
                        ...
                        React.createElement("div", {className: "toolAction"}, 
                            React.createElement("div", {className: "toolOptions"}, 
                                React.createElement("span", {className: "flow"}, 
                                    React.createElement("a", {name: toolStatusLabel, href: tool.link}, toolStatusLabel)
                                ), 
...
},{"../mixins/content":4,"classnames":6,"react":152,"underscore":153}],3:[function(require,module,exports){
/** @jsx React.DOM */
  ...
  getInitialState: function() {
    ...
    var toolNodes = this.state.data.tools.map(function(tool) {
      ...
      React.createElement("li", {className: "mer-more-menu"}, 
        React.createElement("a", {name: "label", href: "#", className: "moreLink"}, 
          this.i18n("label")
        ), 
        React.createElement("ul", null, 
          toolNodes
...
module.exports = function (elementId, options) {
  ...
  $.ajax({
      ...
      success: function(data) {
        React.render(
          React.createElement(ToolsDropdown, {url: serviceUrl ? serviceUrl : "", dictionary: data?data:{}}),
          document.getElementById(elementId)
        )
      }.bind(this),
      error: function(xhr, status, err) {
